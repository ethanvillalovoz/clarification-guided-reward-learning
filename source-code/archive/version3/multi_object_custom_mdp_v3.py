...
#     - Different colors
# Version 3 changes:
#     - Changing input structure to being more as a tree like structure than single vector
...
class Gridworld():
    ...
    def lookup_quadrant_reward(self, input_state):
        ...
        for idx, obj in enumerate(objects_list):
            ...
            # Check if object_type exists in preferences
            if object_type in f_Ethan['pref_values']:
                object_pref = f_Ethan['pref_values'][object_type]

                # Check for color or material preferences based on object type
